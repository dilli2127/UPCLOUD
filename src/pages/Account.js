            ...
            <div className="account-content">
                ...
                {activeTab === 'billing' && (
                    <div className="account-section">
                         ...
                         <p className="billing-desc">Manage your billing address and payment methods.</p>
                         
                         <div className="details-card">
                            <h3>Address</h3>
                            <p>Naduvan Tech<br/>123 Innovation Dr<br/>Chennai, TN 600000<br/>India</p>
                            <button className="btn-link">Edit address</button>
                         </div>

                         <div className="divider"></div>

                         <h2 className="section-heading">Payment methods</h2>
                         <div className="payment-method-card">
                            <div className="card-icon"><CreditCard size={24} /></div>
                            <div className="card-info">
                                <div className="card-num">•••• •••• •••• 4242</div>
                                <div className="card-exp">Expires 12/28</div>
                            </div>
                            <div className="card-badge">Default</div>
                         </div>
                         <button className="btn-add-card">+ Add new credit card</button>
                    </div>
                )}
            </div>
        </div>
